...
export default async function buildPrompt(req, res) {
    ...
    const newPrompt = `Answer the question based on the context below and expand on it. With code examples if you can where applicable. If the question can't be answered based on the context, say "I don't know"\n\nContext: ${context}\n\n---\n\nQuestion: ${prompt}\nAnswer:`;
